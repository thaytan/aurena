#ifndef __ODAS_CONFIGS__
#define __ODAS_CONFIGS__

#include <odas/odas.h>
#include "odas-parameters.h"

typedef struct odas_configs odas_configs;
...
void odas_configs_construct(odas_configs *cfgs, const char * file_config);
void odas_configs_destroy(odas_configs * cfgs);
