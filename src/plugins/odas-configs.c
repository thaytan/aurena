...
void
odas_configs_construct (odas_configs * cfgs, const char *file_config)
{
  // +----------------------------------------------------------+
  // | Raw                                                      |
  // +----------------------------------------------------------+  
  ...
  cfgs->msg_powers_mics_config =
      parameters_msg_powers_mics_config (file_config);
  ...
  cfgs->inj_targets_sst_config =
      parameters_inj_targets_sst_config (file_config);
  ...
  cfgs->msg_targets_sst_config =
      parameters_msg_targets_sst_config (file_config);
  ...
  cfgs->msg_spectra_pfs_config =
      parameters_msg_spectra_pfs_config (file_config);
  ...
  cfgs->msg_hops_pfs_rs_config =
      parameters_msg_hops_pfs_rs_config (file_config);
  ...
  cfgs->mod_volume_seps_config =
      parameters_mod_volume_seps_config (file_config);
...
void
odas_configs_destroy (odas_configs * cfgs)
{
